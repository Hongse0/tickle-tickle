...
<template>
  <div id="sidenav-collapse-main" class="collapse navbar-collapse w-auto h-auto h-100">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-collapse collapse-ref="pagesExamples" nav-text="거래내역 통계"
      ...
      <li class="nav-item">
        <sidenav-collapse collapse-ref="applicationsExamples" nav-text="거래"
      ...
      <li class="nav-item">
        <sidenav-collapse collapse-ref="ecommerceExamples" nav-text="챌린지"
          ...
          <template #list>
            <ul class="nav ms-4">
              <!-- nav links -->
              <sidenav-item to="/challenge/list" mini-icon="O" text="챌린지 목록" />
      ...
      <li class="nav-item">
        <sidenav-collapse collapse-ref="authExamples" nav-text="투자"
          ...
          <template #list>
            <ul class="nav ms-4">
              <!-- nav links -->
              <sidenav-item to="/investment" mini-icon="O" text="투자 추천" />
            </ul>
          </template>
        </sidenav-collapse>
      </li>
